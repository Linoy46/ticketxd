...
import { ct_constancia_curso as _ct_constancia_curso } from "./modelsPromette/ct_constancia_curso";
import type { ct_constancia_cursoAttributes, ct_constancia_cursoCreationAttributes } from "./modelsPromette/ct_constancia_curso";
import { dt_constancia_curso_persona as _dt_constancia_curso_persona } from "./modelsPromette/dt_constancia_curso_persona";
import type { dt_constancia_curso_personaAttributes, dt_constancia_curso_personaCreationAttributes } from "./modelsPromette/dt_constancia_curso_persona";
import { ct_accion as _ct_accion } from "./modelsPromette/ct_accion";
import type { ct_accionAttributes, ct_accionCreationAttributes } from "./modelsPromette/ct_accion";
import { ct_capitulo as _ct_capitulo } from "./modelsPromette/ct_capitulo";
import type { ct_capituloAttributes, ct_capituloCreationAttributes } from "./modelsPromette/ct_capitulo";
import { ct_clasificacion_prioridad as _ct_clasificacion_prioridad } from "./modelsPromette/ct_clasificacion_prioridad";
import type { ct_clasificacion_prioridadAttributes, ct_clasificacion_prioridadCreationAttributes } from "./modelsPromette/ct_clasificacion_prioridad";
import { ct_codigos_postales as _ct_codigos_postales } from "./modelsPromette/ct_codigos_postales";
import type { ct_codigos_postalesAttributes, ct_codigos_postalesCreationAttributes } from "./modelsPromette/ct_codigos_postales";
import { ct_consumible_factura as _ct_consumible_factura } from "./modelsPromette/ct_consumible_factura";
import type { ct_consumible_facturaAttributes, ct_consumible_facturaCreationAttributes } from "./modelsPromette/ct_consumible_factura";
import { ct_consumibles_proveedor as _ct_consumibles_proveedor } from "./modelsPromette/ct_consumibles_proveedor";
import type { ct_consumibles_proveedorAttributes, ct_consumibles_proveedorCreationAttributes } from "./modelsPromette/ct_consumibles_proveedor";
import { ct_correspondencia_estado as _ct_correspondencia_estado } from "./modelsPromette/ct_correspondencia_estado";
import type { ct_correspondencia_estadoAttributes, ct_correspondencia_estadoCreationAttributes } from "./modelsPromette/ct_correspondencia_estado";
import { ct_dispositivo as _ct_dispositivo } from "./modelsPromette/ct_dispositivo";
import type { ct_dispositivoAttributes, ct_dispositivoCreationAttributes } from "./modelsPromette/ct_dispositivo";
import { ct_financiamiento as _ct_financiamiento } from "./modelsPromette/ct_financiamiento";
import type { ct_financiamientoAttributes, ct_financiamientoCreationAttributes } from "./modelsPromette/ct_financiamiento";
import { ct_forma_entrega as _ct_forma_entrega } from "./modelsPromette/ct_forma_entrega";
import type { ct_forma_entregaAttributes, ct_forma_entregaCreationAttributes } from "./modelsPromette/ct_forma_entrega";
import { ct_modulo as _ct_modulo } from "./modelsPromette/ct_modulo";
import type { ct_moduloAttributes, ct_moduloCreationAttributes } from "./modelsPromette/ct_modulo";
import { ct_municipio as _ct_municipio } from "./modelsPromette/ct_municipio";
import type { ct_municipioAttributes, ct_municipioCreationAttributes } from "./modelsPromette/ct_municipio";
import { ct_partida as _ct_partida } from "./modelsPromette/ct_partida";
import type { ct_partidaAttributes, ct_partidaCreationAttributes } from "./modelsPromette/ct_partida";
import { ct_producto_consumible as _ct_producto_consumible } from "./modelsPromette/ct_producto_consumible";
import type { ct_producto_consumibleAttributes, ct_producto_consumibleCreationAttributes } from "./modelsPromette/ct_producto_consumible";
import { ct_puesto as _ct_puesto } from "./modelsPromette/ct_puesto";
import type { ct_puestoAttributes, ct_puestoCreationAttributes } from "./modelsPromette/ct_puesto";
import { ct_sindicato as _ct_sindicato } from "./modelsPromette/ct_sindicato";
import type { ct_sindicatoAttributes, ct_sindicatoCreationAttributes } from "./modelsPromette/ct_sindicato";
import { ct_tabla as _ct_tabla } from "./modelsPromette/ct_tabla";
import type { ct_tablaAttributes, ct_tablaCreationAttributes } from "./modelsPromette/ct_tabla";
import { ct_unidad_medida as _ct_unidad_medida } from "./modelsPromette/ct_unidad_medida";
import type { ct_unidad_medidaAttributes, ct_unidad_medidaCreationAttributes } from "./modelsPromette/ct_unidad_medida";
import { ct_usuario as _ct_usuario } from "./modelsPromette/ct_usuario";
import type { ct_usuarioAttributes, ct_usuarioCreationAttributes } from "./modelsPromette/ct_usuario";
import { dt_aspirante_aneec as _dt_aspirante_aneec } from "./modelsPromette/dt_aspirante_aneec";
import type { dt_aspirante_aneecAttributes, dt_aspirante_aneecCreationAttributes } from "./modelsPromette/dt_aspirante_aneec";
import { dt_bitacora as _dt_bitacora } from "./modelsPromette/dt_bitacora";
import type { dt_bitacoraAttributes, dt_bitacoraCreationAttributes } from "./modelsPromette/dt_bitacora";
import { dt_consumible_entrega as _dt_consumible_entrega } from "./modelsPromette/dt_consumible_entrega";
import type { dt_consumible_entregaAttributes, dt_consumible_entregaCreationAttributes } from "./modelsPromette/dt_consumible_entrega";
import { dt_consumible_inventario as _dt_consumible_inventario } from "./modelsPromette/dt_consumible_inventario";
import type { dt_consumible_inventarioAttributes, dt_consumible_inventarioCreationAttributes } from "./modelsPromette/dt_consumible_inventario";
import { dt_correspondencia as _dt_correspondencia } from "./modelsPromette/dt_correspondencia";
import type { dt_correspondenciaAttributes, dt_correspondenciaCreationAttributes } from "./modelsPromette/dt_correspondencia";
import { dt_diagnostico_aneec as _dt_diagnostico_aneec } from "./modelsPromette/dt_diagnostico_aneec";
import type { dt_diagnostico_aneecAttributes, dt_diagnostico_aneecCreationAttributes } from "./modelsPromette/dt_diagnostico_aneec";
import { dt_funcion as _dt_funcion } from "./modelsPromette/dt_funcion";
import type { dt_funcionAttributes, dt_funcionCreationAttributes } from "./modelsPromette/dt_funcion";
import { dt_informes_aneec as _dt_informes_aneec } from "./modelsPromette/dt_informes_aneec";
import type { dt_informes_aneecAttributes, dt_informes_aneecCreationAttributes } from "./modelsPromette/dt_informes_aneec";
import { dt_proyecto_anual as _dt_proyecto_anual } from "./modelsPromette/dt_proyecto_anual";
import type { dt_proyecto_anualAttributes, dt_proyecto_anualCreationAttributes } from "./modelsPromette/dt_proyecto_anual";
import { dt_techo_presupuesto as _dt_techo_presupuesto } from "./modelsPromette/dt_techo_presupuesto";
import type { dt_techo_presupuestoAttributes, dt_techo_presupuestoCreationAttributes } from "./modelsPromette/dt_techo_presupuesto";
import { rl_analista_unidad as _rl_analista_unidad } from "./modelsPromette/rl_analista_unidad";
import type { rl_analista_unidadAttributes, rl_analista_unidadCreationAttributes } from "./modelsPromette/rl_analista_unidad";
import { rl_area_financiero as _rl_area_financiero } from "./modelsPromette/rl_area_financiero";
import type { rl_area_financieroAttributes, rl_area_financieroCreationAttributes } from "./modelsPromette/rl_area_financiero";
import { rl_correspondencia_usuario_estado as _rl_correspondencia_usuario_estado } from "./modelsPromette/rl_correspondencia_usuario_estado";
import type { rl_correspondencia_usuario_estadoAttributes, rl_correspondencia_usuario_estadoCreationAttributes } from "./modelsPromette/rl_correspondencia_usuario_estado";
import { rl_entrega_formato as _rl_entrega_formato } from "./modelsPromette/rl_entrega_formato";
import type { rl_entrega_formatoAttributes, rl_entrega_formatoCreationAttributes } from "./modelsPromette/rl_entrega_formato";
import { rl_justificacion as _rl_justificacion } from "./modelsPromette/rl_justificacion";
import type { rl_justificacionAttributes, rl_justificacionCreationAttributes } from "./modelsPromette/rl_justificacion";
import { rl_modulo_area as _rl_modulo_area } from "./modelsPromette/rl_modulo_area";
import type { rl_modulo_areaAttributes, rl_modulo_areaCreationAttributes } from "./modelsPromette/rl_modulo_area";
import { rl_partida_area as _rl_partida_area } from "./modelsPromette/rl_partida_area";
import type { rl_partida_areaAttributes, rl_partida_areaCreationAttributes } from "./modelsPromette/rl_partida_area";
import { rl_producto_area as _rl_producto_area } from "./modelsPromette/rl_producto_area";
import type { rl_producto_areaAttributes, rl_producto_areaCreationAttributes } from "./modelsPromette/rl_producto_area";
import { rl_producto_requisicion as _rl_producto_requisicion } from "./modelsPromette/rl_producto_requisicion";
import type { rl_producto_requisicionAttributes, rl_producto_requisicionCreationAttributes } from "./modelsPromette/rl_producto_requisicion";
import { rl_puesto_funcion as _rl_puesto_funcion } from "./modelsPromette/rl_puesto_funcion";
import type { rl_puesto_funcionAttributes, rl_puesto_funcionCreationAttributes } from "./modelsPromette/rl_puesto_funcion";
import { rl_usuario_funcion as _rl_usuario_funcion } from "./modelsPromette/rl_usuario_funcion";
import type { rl_usuario_funcionAttributes, rl_usuario_funcionCreationAttributes } from "./modelsPromette/rl_usuario_funcion";
import { rl_usuario_puesto as _rl_usuario_puesto } from "./modelsPromette/rl_usuario_puesto";
import type { rl_usuario_puestoAttributes, rl_usuario_puestoCreationAttributes } from "./modelsPromette/rl_usuario_puesto";

export {
  _ct_constancia_curso as ct_constancia_curso,
  _dt_constancia_curso_persona as dt_constancia_curso_persona,
...
export type {
  ct_constancia_cursoAttributes,
  ct_constancia_cursoCreationAttributes,
  dt_constancia_curso_personaAttributes,
  dt_constancia_curso_personaCreationAttributes,
  ct_accionAttributes,
...
export function initModels(sequelize: Sequelize) {
  const ct_constancia_curso = _ct_constancia_curso.initModel(sequelize);
  const dt_constancia_curso_persona = _dt_constancia_curso_persona.initModel(sequelize);
  ...
  rl_justificacion.belongsTo(rl_area_financiero, { as: "ct_area", foreignKey: "ct_area_id"});
  rl_area_financiero.hasMany(rl_justificacion, { as: "rl_justificacions", foreignKey: "ct_area_id"});
  ...
  return {
    ct_constancia_curso: ct_constancia_curso,
    dt_constancia_curso_persona: dt_constancia_curso_persona,
    ct_accion: ct_accion,
